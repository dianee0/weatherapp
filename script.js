...
btn.addEventListener("click", function() {
    ...
    xhr.open("GET", `http://localhost:3000/weather/${latitude}/${longitude}`); // this opens a get request to the website
    ...
    xhr2.onload = function() {
        ...
        let forecast = body; // does it need to be var or let?
        ...
        // forecast = [["M", 52], ["Tu", 53], ["W", 54], ["Th", 55], ["F", 56]]; // nested array of projected forecast
        ...
        //     forecastElements[i].innerHTML = forecast[i].dayname + ": " + forecast[i].temp + "\u00B0F"; // sets the innerHtml of the i'th 'forecast div element to a string in the format of "Day: Temp°F"
        // }
    } // closes xhr2
